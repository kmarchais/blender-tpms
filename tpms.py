...
class Tpms:
    def __init__(
        ...
        surface: str = "gyroid",
        swap: str = "XYZ",
        cell_size: Union[float, Sequence[float], np.ndarray] = 1.0,
        repeat_cell: Union[int, Sequence[int], np.ndarray] = 1,
        resolution: int = 20,
        offset: Union[float, Field] = 0.0,
        phase_shift: Union[float, Sequence[float], np.ndarray] = (0.0, 0.0, 0.0),
    ):
        if swap not in map("".join, itertools.permutations("XYZ")):
            raise ValueError("swap must be a permutation of 'XYZ'")
    ...
    def _init_cell_parameters(
        self,
        cell_size: Union[float, Sequence[float], np.ndarray],
        repeat_cell: Union[int, Sequence[int], np.ndarray],
    ):
...
class CylindricalTpms(Tpms):
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            cell_size=self.cell_size, repeat_cell=self.repeat_cell, **kwargs
        )
